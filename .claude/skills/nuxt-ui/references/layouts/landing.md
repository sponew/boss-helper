...
- `UPageHero` — hero with title, description, links, and optional media. Use `` for side-by-side layout.
...
```vue
<UPageSection title="Feature A" >
  <img src="/feature-a.png" />
</UPageSection>

<UPageSection title="Feature B"  reverse>
